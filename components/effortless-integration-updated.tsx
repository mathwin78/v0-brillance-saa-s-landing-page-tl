    ...
    >
      ...
      <div
        style={{
          ...
          height: "240px",
          borderRadius: "50%",
          border: "1px solid rgba(36, 36, 41, 0.25)",
          opacity: 0.7,
        }}
      />
      {/* Inner ring */}
      <div
        style={{
          ...
          height: "160px",
          borderRadius: "50%",
          border: "1px solid rgba(36, 36, 41, 0.3)",
          opacity: 0.6,
        }}
      />
        ...
        >
          <defs>
            <linearGradient id="connectionGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="rgba(36, 36, 41, 0.1)" />
              <stop offset="50%" stopColor="rgba(36, 36, 41, 0.05)" />
              <stop offset="100%" stopColor="rgba(36, 36, 41, 0.1)" />
            </linearGradient>
          </defs>

export default function FooterSection() {
  return (
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#242429] text-xl font-semibold leading-4 font-sans">Brillance</div>
          </div>
          <div className="text-[rgba(36,36,41,0.90)] text-sm font-medium leading-[18px] font-sans">
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-[rgba(36,36,41,0.50)] text-sm font-medium leading-5 font-sans">
              Product
            </div>
            <div className="flex flex-col justify-end items-start gap-2">
              <div className="text-[#242429] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#242429] transition-colors">
                Features
              </div>
              <div className="text-[#242429] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#242429] transition-colors">
                Pricing
          ...
          {/* Company Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(36,36,41,0.50)] text-sm font-medium leading-5 font-sans">Company</div>
          ...
          {/* Resources Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(36,36,41,0.50)] text-sm font-medium leading-5 font-sans">Resources</div>
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-[#242429] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#242429] transition-colors">
                Terms of use
              </div>
              <div className="self-stretch text-[#242429] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#242429] transition-colors">
                API Reference
      ...
      <div className="self-stretch h-12 relative overflow-hidden border-t border-b border-[rgba(36,36,41,0.12)]">

...
export default function PricingSection() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2">
      {/* Header Section */}
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(36,36,41,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          ...
          {/* Title */}
          <div className="self-stretch text-center flex justify-center flex-col text-[#242429] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
      ...
      <div className="self-stretch px-6 md:px-16 py-9 relative flex justify-center items-center gap-4">
        {/* Horizontal line */}
        <div className="w-full max-w-[1060px] h-0 absolute left-1/2 transform -translate-x-1/2 top-[63px] border-t border-[rgba(36,36,41,0.12)] z-0"></div>

        {/* Toggle Container */}
        <div className="p-3 relative bg-[rgba(36,36,41,0.03)] border border-[rgba(36,36,41,0.02)] backdrop-blur-[44px] backdrop-saturate-150 backdrop-brightness-110 flex justify-center items-center rounded-lg z-20 before:absolute before:inset-0 before:bg-white before:opacity-60 before:rounded-lg before:-z-10">
          <div className="p-[2px] bg-[rgba(36,36,41,0.10)] shadow-[0px_1px_0px_white] rounded-[99px] border-[0.5px] border-[rgba(36,36,41,0.08)] flex justify-center items-center gap-[2px] relative">
            <div
            ...
            >
              <div
                className={`text-[13px] font-medium leading-5 font-sans transition-colors duration-300 ${
                  billingPeriod === "annually" ? "text-[#242429]" : "text-[#6B7280]"
                }`}
              >
                Annually
              </div>
            ...
            >
              <div
                className={`text-[13px] font-medium leading-5 font-sans transition-colors duration-300 ${
                  billingPeriod === "monthly" ? "text-[#242429]" : "text-[#6B7280]"
                }`}
              >
                Monthly
              </div>
          ...
          {/* Decorative dots */}
          <div className="w-[3px] h-[3px] absolute left-[5px] top-[5.25px] bg-[rgba(36,36,41,0.10)] shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-[3px] h-[3px] absolute right-[5px] top-[5.25px] bg-[rgba(36,36,41,0.10)] shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-[3px] h-[3px] absolute left-[5px] bottom-[5.25px] bg-[rgba(36,36,41,0.10)] shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-[3px] h-[3px] absolute right-[5px] bottom-[5.25px] bg-[rgba(36,36,41,0.10)] shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
        </div>
      </div>

      {/* Pricing Cards Section */}
      <div className="self-stretch border-b border-t border-[rgba(36,36,41,0.12)] flex justify-center items-center">
        <div className="flex justify-center items-start w-full">
          ...
          <div className="flex-1 flex flex-col md:flex-row justify-center items-center gap-6 py-12 md:py-0">
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 border border-[rgba(50,45,43,0.12)] border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12 bg-[rgba(255,255,255,0)]">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-[rgba(36,36,41,0.90)] text-lg font-medium leading-7 font-sans">Starter</div>
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="flex flex-col justify-start items-start gap-1">
                    <div className="relative h-[60px] flex items-center text-[#242429] text-5xl font-medium leading-[60px] font-serif">
                ...
                <div className="self-stretch px-4 py-[10px] relative bg-[#242429] shadow-[0px_2px_4px_rgba(36,36,41,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center">
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-2">
                {[
                  ...
                  <div key={index} className="self-stretch flex justify-start items-center gap-[13px]">
                    ...
                    <div className="flex-1 text-[rgba(36,36,41,0.80)] text-[12.5px] font-normal leading-5 font-sans">
                      {feature}
                    </div>
                  </div>
                ))}
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-[#242429] border border-[rgba(50,45,43,0.12)] border-[rgba(36,36,41,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
              {/* Plan Header */}
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                ...
                {/* CTA Button */}
                <div className="self-stretch px-4 py-[10px] relative bg-[#FBFAF9] shadow-[0px_2px_4px_rgba(36,36,41,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center">
                  ...
                  <div className="max-w-[108px] flex justify-center flex-col text-[#242429] text-[13px] font-medium leading-5 font-sans">
                    Get started
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-white border border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-[rgba(36,36,41,0.90)] text-lg font-medium leading-7 font-sans">Enterprise</div>
                  <div className="w-full max-w-[242px] text-[rgba(41,37,35,0.70)] text-sm font-normal leading-5 font-sans">

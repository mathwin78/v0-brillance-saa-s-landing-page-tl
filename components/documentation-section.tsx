    ...
    <div className="w-full border-b border-[rgba(36,36,41,0.12)] flex flex-col justify-center items-center">
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(36,36,41,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          <Badge
            icon={
              <div className="w-[10.50px] h-[10.50px] outline outline-[1.17px] outline-[#242429] outline-offset-[-0.58px] rounded-full"></div>
            }
              ...
              return (
                ...
                >
                  ...
                  <div className="px-6 py-5 w-full flex flex-col gap-2">
                    <div className="self-stretch flex justify-center flex-col text-[#242429] text-sm font-semibold leading-6 font-sans">
                      {card.title}
                    </div>

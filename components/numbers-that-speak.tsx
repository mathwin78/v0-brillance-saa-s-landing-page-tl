...
const NumbersThatSpeak: React.FC<NumbersThatSpeakProps> = ({
  ...
  const themeVars =
    theme === "light"
      ? {
          "--nts-surface": "#ffffff",
          "--nts-text-primary": "#242429",
          "--nts-text-secondary": "rgba(36,36,41,0.8)",
          "--nts-text-muted": "rgba(36,36,41,0.7)",
          "--nts-border": "rgba(36,36,41,0.12)",
          "--nts-shadow": "rgba(36,36,41,0.06)",
        }
      : ({
          "--nts-surface": "#ffffff",
          "--nts-text-primary": "#242429",
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.587px rgba(36,36,41,0.12), 0px 1.174px 2.348px -0.587px rgba(36,36,41,0.06), 0px 1.761px 3.522px -0.88px rgba(36,36,41,0.06)",
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.717px rgba(36,36,41,0.12), 0px 1.435px 2.87px -0.717px rgba(36,36,41,0.06), 0px 2.152px 4.304px -1.076px rgba(36,36,41,0.06)",
                maskImage: `url('${imgSchedule}')`,
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.783px rgba(36,36,41,0.12), 0px 1.565px 3.13px -0.783px rgba(36,36,41,0.06), 0px 2.348px 4.696px -1.174px rgba(36,36,41,0.06)",
                maskImage: `url('${imgSchedule}')`,
